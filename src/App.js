...
function App() {
  ...
  useEffect(() => {
    if (
      agentStatus === false &&
      userSession &&
      userSession.user.user_metadata.userType === "agent"
    ) {
      // console.log(agentStatus)
  ...
  const userTypeRoutes = () => {
    if (userSession && auth) {
      if (userSession.user.user_metadata.userType === "agent" && agentStatus) {
        return (
          <>
            ...
            <Route path="/agent/" element={<AgentLayout />}>
              ...
              <Route
                path="roomRental/rentalAgreement"
        ...
        return (
          <>
            ...
            <Route path="/student/" element={<StudentLayout />}>
              ...
              <Route
                path="roommate/myListings/viewRoommate/:id"
                element={<RoommateRequest />}
              />
              <Route
                path="roommate/myListings/:id"
                element={<ListingPostDetails />}
              />
        ...
        userSession &&
        userSession.user.user_metadata.userType !== "student" &&
        userSession.user.user_metadata.userType !== "agent"
      ) {
        return (
          <>
            ...
            <Route
              path="/forgot-password"
              element={<Navigate to="/superadmin" />}
            />
            <Route
              path="/update-password"
              element={<Navigate to="/superadmin" />}
